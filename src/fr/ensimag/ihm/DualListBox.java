...
public class DualListBox extends JPanel {
    ...
    private static final String DEFAULT_SOURCE_CHOICE_LABEL = "Liste des stagiaires";

    private static final String DEFAULT_DEST_CHOICE_LABEL = "Stagiaires participants";
    ...
    // retourne le nombre d'objets selectionnes
    public int getSelectedNumber() {
        int count = 0;
        Iterator it = this.destinationIterator();
        while (it.hasNext()) {
            count++;
            it.next();
        }
